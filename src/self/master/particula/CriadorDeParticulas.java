...
public class CriadorDeParticulas extends Dimensional {
	...
	private ArrayList<ArrayList<Image>> imgs = new ArrayList<ArrayList<Image>>();
	private float scale;
	...
	public CriadorDeParticulas(int xOri, int yOri, int widthOri, int heightOri, int widthPar, int heightPar, Color color, int porcentagem) {
		this.x = xOri;
		this.y = yOri;
	...
	public CriadorDeParticulas(int xOri, int yOri, int widthOri, int heightOri, ArrayList<Image> imgs, float scale, int tickPorIndex, int porcentagem) {
		this.x = xOri;
		this.y = yOri;
		this.widthPar = 1;
		this.heightPar = 1;
	...
	public CriadorDeParticulas(int xOri, int yOri, int widthOri, int heightOri, Image img, float scale, int tickPorIndex, int porcentagem) {
		this.x = xOri;
		this.y = yOri;
		this.widthPar = 1;
		this.heightPar = 1;
	...
	public void addImgs(ArrayList<Image> imgs) {
		this.imgs.add(imgs);
	}
	
	public void addImgs(Image img) {
		ArrayList<Image> imgAl = new ArrayList<Image>();
		imgAl.add(img);
		this.imgs.add(imgAl);
	}
	
	private ArrayList<Image> getImgs() {
